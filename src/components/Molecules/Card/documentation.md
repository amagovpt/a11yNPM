...
O `Card` é um componente de menu lateral utilizado em dashboards para navegação entre diferentes seções ou páginas. Ele é fixado no lado esquerdo da tela e suporta itens de menu com ícones e rótulos.
